    ...
    try:
        ...
        welcome_embed = discord.Embed(
            ...
            description=(
                ...
                "• ใช้คำสั่ง !gp ตามด้วยจำนวนโรบัคเพื่อเช็คราคา\n"
                "**ขอบคุณที่ใช้บริการ!** 🎉"
            ),
            color=0x00FF99
        )
...
async def start_auto_close_countdown(channel):
    ...
    print(f"🕐 เริ่มนับถอยหลังปิดตั๋วอัตโนมัติ {channel.name} ใน 1 ชั่วโมง")
...
async def update_main_channel():
    ...
    try:
        ...
        group_value = (
            ...
            "เรท 4.5 = 500 บาทขึ้นไป ⚠️เข้ากลุ่มให้ครบ 15 วันก่อนซื้อ⚠️\n"
            "```\n"
