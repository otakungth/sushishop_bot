...
# Emoji
ROBUX_EMOJI = "<:sushirobux:YOUR_EMOJI_ID_HERE>"  # Replace with your actual emoji ID
        ...
        async def deliver_cb(i):
            ...
            async def confirm_cb(interaction):
                try:
                    ...
                    # Add "สั่งของต่อ" button after receipt
                    ...
                    async def order_more_cb(interaction):
                        if interaction.channel.id != self.channel.id:
                        ...
                        cancel_removal(self.channel.id)
                        ...
                        if stock_type == "gamepass":
                            ...
                            async def form_callback(interaction2):
                                if interaction2.channel.id == self.channel.id:
                                    modal = GamepassTicketModal()
                    ...
                    await self.channel.send("📝 ต้องการสั่งสินค้าเพิ่ม?", view=order_more_view)
