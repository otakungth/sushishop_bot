...
class QRView(View):
    ...
    async def copy_bank_account(self, interaction: discord.Interaction, button: Button):
        ...
        try:
            bank_info = "120-239181-3 :(ธนาคาร SCB ชื่อ: หจก. วอเตอร์ เทค เซลล์ แอนด์ เซอร์วิส) **กรุณาโน๊ตชื่อสินค้าที่ซื้อใต้สลิปเพื่อให้ทางร้านเริ่มดำเนินการจัดส่งสินค้า**"
...
async def qr(ctx):
    ...
    # ✅ แก้ไขตามข้อ 3
    embed = discord.Embed(
        title="📱ช่องทางการโอนเงิน โน๊ตสลิประบุชื่อสินค้าที่ซื้อด้วย⚠️",
        color=0x00CCFF
    )
    ...
    embed.set_image(url="https://discord.com/channels/@me/1434946668482007091/1444689330911051907")
